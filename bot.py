...
class KiteAI:
    ...
    def print_deposit_question(self):
        while True:
            try:
                deposit_amount = int(float(f"{Fore.YELLOW + Style.BRIGHT}Enter Deposit Amount [KITE] -> {Style.RESET_ALL}").strip())
                if deposit_amount > 0:
    ...
    def print_withdraw_kite_question(self):
        while True:
            try:
                withdraw_kite_amount = int(float(f"{Fore.YELLOW + Style.BRIGHT}Enter Withdraw Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
    ...
    def print_withdraw_usdt_question(self):
        while True:
            try:
                withdraw_usdt_amount = int(float(f"{Fore.YELLOW + Style.BRIGHT}Enter Withdraw Amount [USDT] (Min. 1 USDT) -> {Style.RESET_ALL}").strip())
    ...
    def print_unstake_question(self):
        while True:
            try:
                unstake_amount = int(float(f"{Fore.YELLOW + Style.BRIGHT}Enter Unstaking Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
                if unstake_amount >= 1:
    ...
    def print_stake_question(self):
        while True:
            try:
                stake_amount = int(float(f"{Fore.YELLOW + Style.BRIGHT}Enter Staking Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
                if stake_amount >= 1:
