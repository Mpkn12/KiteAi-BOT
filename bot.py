...
class KiteAI:
    ...
    def print_deposit_question(self):
        while True:
            try:
                deposit_amount = float(input(f"{Fore.YELLOW + Style.BRIGHT}Enter Deposit Amount [KITE] -> {Style.RESET_ALL}").strip())
                if deposit_amount > 0:
    ...
    def print_withdraw_kite_question(self):
        while True:
            try:
                withdraw_kite_amount = float(input(f"{Fore.YELLOW + Style.BRIGHT}Enter Withdraw Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
                if withdraw_kite_amount >= 0:
    ...
    def print_withdraw_usdt_question(self):
        while True:
            try:
                withdraw_usdt_amount = float(input(f"{Fore.YELLOW + Style.BRIGHT}Enter Withdraw Amount [USDT] (Min. 1 USDT) -> {Style.RESET_ALL}").strip())
                if withdraw_usdt_amount >= 0:
    ...
    def print_unstake_question(self):
        ...
        while True:
            try:
                unstake_amount = float(input(f"{Fore.YELLOW + Style.BRIGHT}Enter Unstaking Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
                if unstake_amount >= 0:
    ...
    def print_stake_question(self):
        ...
        while True:
            try:
                stake_amount = float(input(f"{Fore.YELLOW + Style.BRIGHT}Enter Staking Amount [KITE] (Min. 1 KITE) -> {Style.RESET_ALL}").strip())
                if stake_amount >= 0:
